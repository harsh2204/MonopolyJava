    ...
    public SuperHero_Data[] setProp()
      {
        ...
        property[13].type = "N";
        //FREDRICTION
        property[14].propName = "Michaelangelo";
    ...
    public void getCards()
      {
        ...
        commActs[3]="M";
        commPos[3]=;
        comm[4] = "Advance to Loki – if you pass Go, collect $200";
        commActs[4]="MMS";
        commPos[4]=;
        commVals[4]=200;
        ...
        commActs[5]="$";
        commVals[5]=50;
        comm[6] = "Get out of Jail free – this card may be kept until needed, or traded/sold";
        commActs[6]="";
        commPos[]=;
        commVals[0]=200;
        comm[7] = "Go to the nearest Special Card. If it's still on sale you may purchase the propery else pay 4 times the amount";
        commActs[7]="";
        commPos[]=;
        commVals[0]=200;
        ...
        commActs[10]="$";
        commVals[10]=25;
        comm[11] = "Take a trip to Stark Tower – if you pass Go collect $200";
        commActs[11]="MMS";
        commPos[11]=;
        commVals[11]=200;
        comm[12] = "Take a trip around S.H.I.E.L.D. Headquarters – advance token to S.H.I.E.L.D. Headquarters";
        commActs[12]="M";
        commPos[12]=;
